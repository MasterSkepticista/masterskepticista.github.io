...
title: 'Graph Search'
date: 2024-08-27
description: "Time for an algorithm shopping spree."
...
> **Note:** Tip: Execute these cells in a notebook for an auto-updating plot.
...
![DFS XKCD](https://imgs.xkcd.com/comics/dfs.png)
...
![Sparse MLP graph](images/sparse_mlp.png)
...
![MLP backward traversal](images/mlp_backward.png)
...
> **Note:** This is an unconventional example of 'sparsely-connected' MLPs. In practice, MLPs are trained fully-connected. Some may find it easier to imagine these graph nodes are arbitrary functions themselves, instead of MLPs.
